...
class LLMRefiner:
    ...
    def _safe_json_parse(self, response_text: str):
        """
        Safely parse JSON response with better error handling and recovery.
        ...
        try:
            ...
            try:
                # Remove trailing commas and fix incomplete JSON
                ...
                logger.error("Could not repair JSON response")
                return None
